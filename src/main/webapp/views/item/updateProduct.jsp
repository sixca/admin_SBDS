                        ...
                        <form id="update_form" class="col s10">
                            <div class="row">
                                <div class="input-field col s7 d-flex justify-content-center">
                                    ...
                                    <input name="registerId" type="hidden" value="${item.registerId}">
                                    <input name="img" type="hidden" value="${item.img}"/>
                                    <input name="isValid" type="hidden" value="${item.isValid}"/>
                                ...
                                <div class="input-field col s4">
                                    <input id="color" name="color" type="text" class="validate" value="${item.color}">
